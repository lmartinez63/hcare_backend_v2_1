...
@Component("getDSForDocumentPostAnesthesiaReport")
public class GetDSForDocumentPostAnesthesiaReport {
    ...
    public Map getDS(Map<String, Object> incomingRequestMap) throws Exception {
        ...
        reportParameters.put("reportTitle","Informe de Post Anestesia");
